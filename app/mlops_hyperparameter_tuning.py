...
import wandb
from pytorch_lightning.loggers import WandbLogger, TensorBoardLogger  # Add TensorBoardLogger import here
...
def train(args):
    ...
    wandb.login()
    wandb_logger = WandbLogger(project="hyperparameter-tuning")
    ...
    # Initialize the data module with parameters
    dm = GLUEDataModule(
